...
<figure>
	...
	<figcaption>(left panel: Weekday, right panel: Weekend)</figcaption>
</figure>
...
5. if we plot the average `percent full` for each station with different colors corresponding to their group assigned by k means, and also the group mean, we can clearly see the difference between those 3 groups
...
6. <span style="color:red">a brief conclusion:</span>
   ...
   * <span style="font-weight:bold">Group 0</span>: <span style="font-weight:bold">high</span> station occupancy during morning and night, <span style="font-weight:bold">median</span> station occupancy during daytime

   * <span style="font-weight:bold">Group 1</span>: has a <span style="font-weight:bold">median</span> 24-hour station occupancy, <span style="font-weight:bold">stable</span> during whole day

   * <span style="font-weight:bold">Group 2</span>: <span style="font-weight:bold">low</span> station occupancy during morning and night, <span style="font-weight:bold">high</span> station occupancy during daytime
