...
>>> println(f"accuracy: ${mce.evaluate(model1.transform(df_train))}%.8f")
>>> println(f"accuracy: ${mce.evaluate(model1.transform(df_val))}%.8f")
>>> println(f"accuracy: ${mce.evaluate(model1.transform(df_test))}%.8f")
