...
The Gapminder plot uses Fertility Rate and Life Expectancy At Birth as x and y coordinate. Each circle represents a different country, and the color and the radius is the region and the population of the country. We will use a Slider to change the frames from year 1960 to year 2013.
