---
title: Scala (part 1)
subtitle: Scala Basics
author: Ding Ma
layout: post
categories: [blog]
---

<span style="font-weight:bold;font-size:32px">1. Tail Recursion</span>
...
* Only functions whose <u>**_last statement is the recursive invocation_**</u> can be optimized for tail-recursion by the Scala compiler.
...
```
---
<span style="font-weight:bold;font-size:32px">2. Stream</span>
...
```
<center><img src="https://dingma129.github.io/assets/figures/scala/scala_1_primeStreamv1.png" width="600" ></center>
```scala
...
```
<center><img src="https://dingma129.github.io/assets/figures/scala/scala_1_primeStreamv2.png" width="600" ></center>
We can see that version 2 is much faster than version 1.

---
<span style="font-weight:bold;font-size:32px">3. Higher-order methods on class `List`</span>
...
```
---
<span style="font-weight:bold;font-size:32px">4. class `Map`</span>
